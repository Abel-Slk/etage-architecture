...
function adaptive_header(w, h) {
	...
	// var socials = $('.main-screen__social');
	// if(w < 767) {
	// 	if (!socials.hasClass('small-screen')) {
	// 		socials.addClass('small-screen').appendTo(menuListWrapper);
	// 	}
	// }
	// else {
	// 	if (socials.hasClass('small-screen')) {
	// 		socials.removeClass('small-screen').appendTo($('.main-screen__column').eq(4));
	// 	}
	// }
}
